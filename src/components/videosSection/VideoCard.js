...
const VideoCard = (props) => {
  ...
  const cardBodyWide = (
    <div className={classes.cardBodyWide}>
      <div className={classes.cardTitleWide}>{props.title}</div>
      ...
      <div className={classes.channelLogoBoxWide}>
        <div className={classes.profileImgBoxWide}>
          <img
            className={classes.profileImgWide}
  ...
  return (
    <Card
      ...
      className={`${
        props.isSearch
          ? "col-12 flex-row"
          : "col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-1 "
      } m-3 flex-grow-1 `}
    >
      <div
        className={`${
          props.isSearch ? classes.cardImageBoxWide : classes.cardImageBox
        }`}
        style={{ backgroundImage: `url('${props.thumbnailUrl}')` }}
        data-testid="videoCard"
      ></div>

      <Card.Body>{props.isSearch ? cardBodyWide : cardBody}</Card.Body>
    </Card>
  );
};
